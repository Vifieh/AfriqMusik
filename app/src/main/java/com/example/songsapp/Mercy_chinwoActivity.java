...
public class Mercy_chinwoActivity extends AppCompatActivity {
...
//                            mediaPlayer.seekTo();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songs.add(new Song("Excess Love", "2018", R.drawable.mercy_chinwo, R.raw.song));
        songs.add(new Song("Bor Ekom", "2017", R.drawable.mercy_chinwo, R.raw.song));
        songs.add(new Song("Chinedum", "2018", R.drawable.mercy_chinwo, R.raw.song));
        songs.add(new Song("Oh Jesus!", "2019", R.drawable.mercy_chinwo, R.raw.song));
        songs.add(new Song("Obinasom", "2019", R.drawable.mercy_chinwo, R.raw.song));
        songs.add(new Song("Akamdinelu", "2018", R.drawable.mercy_chinwo, R.raw.song));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    //play current song
                    mediaPlayer = MediaPlayer.create(Mercy_chinwoActivity.this, song.getAudioResourceId());
                    //start song
                    mediaPlayer.start();
